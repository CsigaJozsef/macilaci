...
namespace MedveLaszlo_Test
{

    [TestClass]
    public class Test
    {
        private OldFileHandler fh;
        ...
        {
            OldFileReader fr = new OldFileReader("../../../maps/easyMap.txt", "../../../maps/mediumMap.txt", "../../../maps/hardMap.txt");
            fh = new OldFileHandler(fr);
