...
{
    public class OldFileHandler
    {
        private readonly OldFileReader _fileReader;
        ...
        public OldFileHandler(OldFileReader fileReader)
        {
        ...
        */
        ...
        public void Load(ref macilaciGameModel model, ref Fields fields, Difficulty diff)
        {
            ...
            for (int i = 0; i < sc; ++i)
            {
                ...
                model.Enemies.Add(new Enemy(new Point(col, row), tf));
            ...
            for (int i = 0; i < basketCount; ++i)
            {
                ...
                model.Baskets.Add(new Basket(new Point(int.Parse(words[0]), int.Parse(words[1]))));
